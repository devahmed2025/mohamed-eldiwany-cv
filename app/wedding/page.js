...
export default function PersonalTrainerApp() {
  ...
  // PDF Generation Logic (COMPLETE FIX - iOS Compatible + Perfect Alignment)
const generatePDF = useCallback(async () => {
    ...
    // Fetch photos and convert to Base64 for iOS compatibility
    const trainerPhotoClosingBase64 = await toDataURL(TRAINER_PHOTO_CLOSING).catch(err => {
        console.error("Error fetching closing photo", err);
        return TRAINER_PHOTO_CLOSING;
    });

    const trainerPhotoCoverBase64 = await toDataURL(TRAINER_PHOTO_COVER).catch(err => {
        console.error("Error fetching cover photo", err);
        return TRAINER_PHOTO_COVER;
    });

    const trainerPhotoBackgroundBase64 = await toDataURL(TRAINER_PHOTO_BACKGROUND).catch(err => {
        console.error("Error fetching background photo", err);
        return TRAINER_PHOTO_BACKGROUND;
    });
    ...
    const renderMeals = () => MEAL_TYPES.map((mealType, index) => `
        <div class="pdf-meal-type ${index > 0 ? 'meal-section-break' : ''}">
            <h3>${T.mealNames[mealType]}</h3>
    ...
    const renderWorkoutTable = (day) => {
        ...
        return `
            <table class="pdf-workout-table">
                <thead>
                    <tr>
                        <th style="width: 35%;">${T.exerciseName}</th>
                        <th style="width: 20%;">${T.muscle}</th>
    ...
    // Render each workout day on separate page
    const renderWorkoutPages = () => WEEKDAY_NAMES.map(day => `
        <div class="pdf-page workout-day-page">
            <div class="pdf-content">
                <div class="pdf-section">
                    <h2 class="workout-day-header">${day} - ${workoutProgram[day]?.length === 0 ? T.restDay : T.activeDay}</h2>
    ...
    const htmlContent = `
        ...
        <head>
            ...
            <style>
                /* CRITICAL: Force print color rendering */
                * { 
                ...
                @media print {
                    ...
                    .workout-day-page { page-break-before: always; }
                }
                ...
                /* Background wrapper with trainer photo */
                .pdf-body-wrapper {
                    position: relative;
                    min-height: 100vh;
                    background-image: url('${trainerPhotoBackgroundBase64}');
                    background-position: center center;
                    background-size: cover;
                    background-attachment: fixed;
                }
                
                .pdf-body-wrapper::before {
                    content: '';
                    position: fixed;
                ...
                .pdf-cover {
                    ...
                    align-items: center;
                    text-align: center;
                    background-image: url('${trainerPhotoCoverBase64}');
                ...
                .pdf-cover .prepared-by { 
                    margin-top: 3em; 
                    font-size: 1.1em; 
                }
                
                .pdf-cover .trainer-name { 
                    font-size: 1.8em; 
                    color: #E0E0E0; 
                    margin: 0.3em 0;
                }
                ...
                .target-macros {
                    ...
                    background: linear-gradient(135deg, #1A1A1A, #252525) padding-box,
                                linear-gradient(45deg, #8C52FF, #A78BFA, #4F46E5) border-box;
                ...
                /* MEAL STYLES - Optimized for long content */
                .pdf-meal-type {
                    margin-bottom: 15px;
                    page-break-inside: auto; /* Allow breaking if too long */
                }
                ...
                .pdf-list-item {
                    ...
                    padding: 5px 0;
                    page-break-inside: avoid; /* Keep meal items together */
                }
                ...
                /* Meal section breaks for long content */
                .meal-section-break {
                ...
                /* WORKOUT DAY PAGES - Each day on separate page */
                .workout-day-page {
                ...
                .workout-day-header {
                    ...
                    margin-bottom: 25px;
                    padding: 15px;
                    background: linear-gradient(90deg, rgba(140, 82, 255, 0.2), rgba(79, 70, 229, 0.2));
                    border-radius: 10px;
                ...
                .pdf-workout-table tbody tr:nth-child(even) { 
                    background: #181818; 
                }
                ...
                .pdf-supplement-item strong { 
                    color: #E0E0E0; 
                    font-size: 1.1em;
                }
                
                .pdf-supplement-item p {
                    margin: 6px 0;
                    color: #B0B0B0;
                }
        ...
        <body>
            <div class="pdf-body-wrapper">
                <div class="pdf-container">
                    ...
                    <div class="pdf-page">
                        ...
                        <div class="pdf-section">
                            ...
                            <div class="pdf-data-item">
                                ...
                                <p style="margin-top: 8px; color: #B0B0B0;">${vegetablesText}</p>
                            </div>
                    ...
                    <!-- PAGE 3+: MEALS - Will auto-paginate if too long -->
                    <div class="pdf-page">
                        <div class="pdf-section">
                            <h2>${T.pdfSection3}</h2>
                        </div>
                    ...
                    <!-- Meals content with auto-pagination -->
                    <div class="pdf-page">
                        <div class="pdf-section">
                            ${renderMeals()}
                        </div>
                    ...
                    <!-- WORKOUT DAYS - Each day on separate page -->
                    ${renderWorkoutPages()}
                    ...
                    <div class="pdf-page">
                        <div class="pdf-trainer-info">
                            ...
                            <p style="margin-top: 20px; font-style: italic; font-size: 1.1em;">
                                نتمنى لك التوفيق في رحلتك الصحية
                            </p>
                        </div>
                    </div>
